<template>
	<view >
		<view >
			...
			<view class="ball" v-if="loadType=='ball'">
				<view class="loading-ball" :style="{width:ballSize_+'px',height:ballSize_+'px',padding:ballInfo.ballPadding}">
					<view class="loading-wave" :style="{overflow:ballInfo.ballType=='all'?'initial':'hidden',width:ballSize_+'px',height:ballSize_+'px'}">
						...
						<view class="loading-text" :style="{lineHeight:ballSize_+'px'}"><text class="font-lg">loading...</text></view>
					</view>
				</view>
			</view>
		</view>
			...
			ballInfo:{
				...
				default:function(){
					var info={
						...
						ballSize:150,//球形的大小，最大200，最小50，超出范围可能样式需要再进行优化
						waveColor:'#fff',//水波颜色
						ballPadding:'0rpx',//球内间距
